...
GetPixelMapfv(map, values)
	return		void
	param		map		PixelMap in value
	param		values		Float32 out array [COMPSIZE()]
	category	VERSION_1_0		   # old: state-req
	dlflags		notlistable
	profile		compatibility
	version		1.0
...
GetPixelMapuiv(map, values)
	return		void
	param		map		PixelMap in value
	param		values		UInt32 out array [COMPSIZE()]
	category	VERSION_1_0		   # old: state-req
	dlflags		notlistable
	profile		compatibility
	version		1.0
...
GetPixelMapusv(map, values)
	return		void
	param		map		PixelMap in value
	param		values		UInt16 out array [COMPSIZE()]
	category	VERSION_1_0		   # old: state-req
	dlflags		notlistable
	profile		compatibility
	version		1.0
...
MultiDrawArrays(mode, first, count, drawcount)
	return		void
	param		mode		BeginMode in value
	param		first		Int32 in array [drawcount]
	param		count		SizeI in array [drawcount]
...
MultiDrawElements(mode, count, type, indices, drawcount)
	...
	param		count		SizeI in array [drawcount]
	param		type		DrawElementsType in value
	param		indices		ConstVoidPointer in array [drawcount]
	param		drawcount	SizeI in value
	category	VERSION_1_4
	version		1.4
	glxropcode	?
...
GetUniformIndices(program, uniformCount, uniformNames, uniformIndices)
	...
	param		uniformNames	ConstCharPointer in array [uniformCount]
	param		uniformIndices	UInt32 out array [uniformCount]
...
GetActiveUniformsiv(program, uniformCount, uniformIndices, pname, params)
	...
	param		program		UInt32 in value
	param		uniformCount	SizeI in value
	param		uniformIndices	UInt32 in array [uniformCount]
	param		pname		GLenum in value
	param		params		Int32 out array [COMPSIZE(pname)]
	category	ARB_uniform_buffer_object
	dlflags		notlistable
...
MultiDrawElementsBaseVertex(mode, count, type, indices, drawcount, basevertex)
	...
	param		indices		ConstVoidPointer in array [drawcount]
	param		drawcount	SizeI in value
	param		basevertex	Int32 in array [drawcount]
	category	ARB_draw_elements_base_vertex
	version		1.2
	extension
	glxropcode	?
...
GetProgramBinary(program, bufSize, length, binaryFormat, binary)
	...
	param		binaryFormat	GLenum out reference
	param		binary		Void out array [length]
...
MultiDrawElementsEXT(mode, count, type, indices, primcount)
	...
	param		count		SizeI in array [primcount]
	param		type		DrawElementsType in value
	param		indices		VoidPointer in array [primcount]
	param		primcount	SizeI in value
	category	EXT_multi_draw_arrays
	version		1.1
	glxropcode	?
...
ElementPointerAPPLE(type, pointer)
	return		void
	param		type		ElementPointerTypeATI in value
	param		pointer		Void in array [COMPSIZE(type)]
...
StringMarkerGREMEDY(len, string)
	return		void
	param		len		SizeI in value
	param		string		Void in array [COMPSIZE(len/string)]
...
Uniform2i64vNV(location, count, value)
	...
	param		location	Int32 in value
	param		count		SizeI in value
	param		value		Int64EXT in array [count*2]
	category	NV_gpu_shader5
	version		4.1
	extension
	glxropcode	?
...
Uniform3i64vNV(location, count, value)
	...
	param		location	Int32 in value
	param		count		SizeI in value
	param		value		Int64EXT in array [count*3]
	category	NV_gpu_shader5
	version		4.1
	extension
	glxropcode	?
...
Uniform4i64vNV(location, count, value)
	...
	param		location	Int32 in value
	param		count		SizeI in value
	param		value		Int64EXT in array [count*4]
	category	NV_gpu_shader5
	version		4.1
	extension
	glxropcode	?
...
Uniform2ui64vNV(location, count, value)
	...
	param		location	Int32 in value
	param		count		SizeI in value
	param		value		UInt64EXT in array [count*2]
	category	NV_gpu_shader5
	version		4.1
	extension
	glxropcode	?
...
Uniform3ui64vNV(location, count, value)
	...
	param		location	Int32 in value
	param		count		SizeI in value
	param		value		UInt64EXT in array [count*3]
	category	NV_gpu_shader5
	version		4.1
	extension
	glxropcode	?
...
Uniform4ui64vNV(location, count, value)
	...
	param		location	Int32 in value
	param		count		SizeI in value
	param		value		UInt64EXT in array [count*4]
	category	NV_gpu_shader5
	version		4.1
	extension
	glxropcode	?
...
#
###############################################################################
InternalTraceCommandRAD(cmd, size, data)
	return		void
	param		cmd		UInt32 in value
	param		size		UInt32 in value
	param		data		UInt8 in array [size]
	category	RAD_debugger
	version		1.0
...
ClearTexImage(texture, level, format, type, data)
	...
	param		format    PixelFormat in value
   param    type      PixelType in value
	param		data      Void in array [COMPSIZE(format/type/level/texture)]
	category	VERSION_4_4
	version    4.4
