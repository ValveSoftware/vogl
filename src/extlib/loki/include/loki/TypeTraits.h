...
#define LOKI_IS_CONST_BIT					0
#define LOKI_IS_VOLATILE_BIT 				1
#define LOKI_IS_REFERENCE_BIT 			2
#define LOKI_IS_FUNCTION					3

#define LOKI_IS_FUNCTION_POINTER 		4
#define LOKI_IS_MEMBER_FUNCTION_POINTER 5
#define LOKI_IS_MEMBER_POINTER			6
#define LOKI_IS_POINTER						7

#define LOKI_IS_STD_UNSIGNED_INT			8
#define LOKI_IS_STD_SIGNED_INT			9
#define LOKI_IS_STD_INTEGRAL				10
#define LOKI_IS_STD_FUNDAMENTAL			11

#define LOKI_IS_UNSIGNED_INT				12
#define LOKI_IS_SIGNED_INT					13
#define LOKI_IS_INTEGRAL					14
#define LOKI_IS_FLOAT						15

#define LOKI_IS_ARITH						16
#define LOKI_IS_FUNDAMENTAL				17
#define LOKI_IS_SIGNED_LONG				18
#define LOKI_IS_UNSIGNED_LONG				19

#define LOKI_TYPE_BITMASK(x) (1U << (x))
...
typedef LOKI_TYPELIST_5(unsigned char, unsigned short int,unsigned int, unsigned long int, unsigned long long int) StdUnsignedInts;
typedef LOKI_TYPELIST_5(signed char, short int,int, long int, long long int) StdSignedInts;
typedef LOKI_TYPELIST_3(bool, char, wchar_t) StdOtherInts;
typedef LOKI_TYPELIST_3(float, double, long double) StdFloats;
typedef LOKI_TYPELIST_1(long) StdSignedLong;
typedef LOKI_TYPELIST_1(unsigned long) StdUnsignedLong;
#else
typedef Loki::Seq<unsigned char, unsigned short int,unsigned int, unsigned long int, unsigned long long int>::Type StdUnsignedInts;
typedef Loki::Seq<signed char, short int,int, long int, long long int>::Type StdSignedInts;
typedef Loki::Seq<bool, char, wchar_t>::Type StdOtherInts;
typedef Loki::Seq<float, double, long double>::Type StdFloats;
typedef Loki::Seq<long>::Type StdSignedLong;
typedef Loki::Seq<unsigned long>::Type StdUnsignedLong;
#endif
...
public:
	...
	enum { isStdSignedLong  = TL::IndexOf<Private::StdSignedLong, UnqualifiedType>::value >= 0 ||
	       TL::IndexOf<Private::StdSignedLong,
	       typename ReferenceTraits<UnqualifiedType>::ReferredType>::value >= 0
	     };

	enum { isStdUnsignedLong  = TL::IndexOf<Private::StdUnsignedLong, UnqualifiedType>::value >= 0 ||
	       TL::IndexOf<Private::StdUnsignedLong,
	       typename ReferenceTraits<UnqualifiedType>::ReferredType>::value >= 0
	     };
...
struct type_is_ptr
{
	enum
	{
		result = TypeTraits<T>::isPointer
	};
};

template<>
struct type_is_ptr<void>
{
	enum
	{
		result = false
